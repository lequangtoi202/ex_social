...
public class JwtTokenProvider implements Serializable {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new SocialApiException(HttpStatus.BAD_REQUEST, "Expired JWT Token");
        } catch (MalformedJwtException e) {
            throw new SocialApiException(HttpStatus.BAD_REQUEST, "Invalid JWT Token");
        } catch (UnsupportedJwtException e) {
            throw new SocialApiException(HttpStatus.BAD_REQUEST, "Unsupported JWT Token");
        } catch (IllegalArgumentException e) {
            throw new SocialApiException(HttpStatus.BAD_REQUEST, "JWT Claims string is empty");
        }
    }
