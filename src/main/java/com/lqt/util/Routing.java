...
public final class Routing {
    ...
    public static final String ALUMNI_PROFILE = BASE_URL + "/profile/alumni/{id}";
    public static final String MY_ACCOUNT = BASE_URL + "/users/me";
    public static final String ASSIGN_ROLE = BASE_URL + "/users/{id}/add-role";
    public static final String LECTURER_PROFILE = BASE_URL + "/profile/lecturer/{id}";
    public static final String CHANGE_PASSWORD = BASE_URL + "/users/change-password/{userId}";
    ...
    public static final String LECTURER_UPDATE_PASSWORD = BASE_URL + "/profile/lecturer/{id}/update-password";
